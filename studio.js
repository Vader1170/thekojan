...
function exitStudio() {
  ...
  document.body.innerHTML = '<div style="background:linear-gradient(145deg,#FAFAF8,#F3F1EB);color:#AEAEB2;font-family:\'DM Mono\',monospace;height:100vh;display:flex;align-items:center;justify-content:center;font-size:11px;letter-spacing:.14em;">SESSION ENDED</div>';
}
